...
func (m SecurityDefinition) GetFXCMSymID() (v string, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMSymPrecision() (v int, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMSymPointSize() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMSymInterestBuy() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMSymInterestSell() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMSymSortOrder() (v int, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMSymMarginRatio() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMSubscriptionStatus() (v string, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMProductID() (v int, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMCondDistStop() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMCondDistLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMCondDistEntryStop() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMCondDistEntryLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMMaxQuantity() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMMinQuantity() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFXCMTradingStatus() (v string, err quickfix.MessageRejectError) {
...
// SetUnderlyin	var f field.UnderlyingStateOrProvinceOfIssueField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
// HasUnderlyingEndPrice returns true if UnderlyingEndPrice is present, Tag 8m.Get(&f); err == nil {
		v = f.Value()
	}
	return
}
...
// HasUnderlyingDirtyPrice returns true if UnderlyingDirtyPrice is present, Tag 882.
func (m NoUnderlyings) HasUnderlyingDirtyPrice() bool {
	return m.Has(tag.UnderlyingDirt{
		v = f.Value()
	}
	return
}
...
etUnderlyingStipValue(v string) {
