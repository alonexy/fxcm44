...
func New(mdreqid field.MDReqIDField, subscriptionrequesttype field.SubscriptionRequestTypeField) (m MarketDataRequest) {
...
func (m MarketDataRequest) SetFXCMTimingInterval(v enum.FXCMTimingInterval) {
	m.Set(field.NewFXCMTimingInterval(v))
}

// SetFXCMStartDate sets FXCMStartDate, Tag 9012.
func (m MarketDataRequest) SetFXCMStartDate(v string) {
	m.Set(field.NewFXCMStartDate(v))
}

// SetFXCMStartTime sets FXCMStartTime, Tag 9013.
func (m MarketDataRequest) SetFXCMStartTime(v string) {
	m.Set(field.NewFXCMStartTime(v))
}

// SetFXCMEndDate sets FXCMEndDate, Tag 9014.
func (m MarketDataRequest) SetFXCMEndDate(v string) {
	m.Set(field.NewFXCMEndDate(v))
}

// SetFXCMEndTime sets FXCMEndTime, Tag 9015.
func (m MarketDataRequest) SetFXCMEndTime(v string) {
	m.Set(field.NewFXCMEndTime(v))
}

// SetFXCMNoSnapshot sets FXCMNoSnapshot, Tag 9021.
func (m MarketDataRequest) SetFXCMNoSnapshot(v int) {
...
func (m MarketDataRequest) GetFXCMTimingInterval() (v enum.FXCMTimingInterval, err quickfix.MessageRejectError) {
...
// GetFXCMStartDate gets FXCMStartDate, Tag 9012.
func (m MarketDataRequest) GetFXCMStartDate() (v string, err quickfix.MessageRejectError) {
	var f field.FXCMStartDateField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
// GetFXCMStartTime gets FXCMStartTime, Tag 9013.
func (m MarketDataRequest) GetFXCMStartTime() (v string, err quickfix.MessageRejectError) {
	var f field.FXCMStartTimeField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
// GetFXCMEndDate gets FXCMEndDate, Tag 9014.
func (m MarketDataRequest) GetFXCMEndDate() (v string, err quickfix.MessageRejectError) {
	var f field.FXCMEndDateField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
// GetFXCMEndTime gets FXCMEndTime, Tag 9015.
func (m MarketDataRequest) GetFXCMEndTime() (v string, err quickfix.MessageRejectError) {
	var f field.FXCMEndTimeField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m MarketDataRequest) GetFXCMNoSnapshot() (v int, err quickfix.MessageRejectError) {
...
func (m MarketDataRequest) HasFXCMTimingInterval() bool {
	return m.Has(tag.FXCMTimingInterval)
}

// HasFXCMStartDate returns true if FXCMStartDate is present, Tag 9012.
func (m MarketDataRequest) HasFXCMStartDate() bool {
	return m.Has(tag.FXCMStartDate)
}

// HasFXCMStartTime returns true if FXCMStartTime is present, Tag 9013.
func (m MarketDataRequest) HasFXCMStartTime() bool {
	return m.Has(tag.FXCMStartTime)
}

// HasFXCMEndDate returns true if FXCMEndDate is present, Tag 9014.
func (m MarketDataRequest) HasFXCMEndDate() bool {
	return m.Has(tag.FXCMEndDate)
}

// HasFXCMEndTime returns true if FXCMEndTime is present, Tag 9015.
func (m MarketDataRequest) HasFXCMEndTime() bool {
	return m.Has(tag.FXCMEndTime)
}

// HasFXCMNoSnapshot returns true if FXCMNoSnapshot is present, Tag 9021.
func (m MarketDataRequest) HasFXCMNoSnapshot() bool {
