...
func (m PositionMaintenanceRequest) SetRoundLot(value decimal.Decimal, scale int32) {
...
func (m PositionMaintenanceRequest) GetRoundLot() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
// GetPosMaintRptRefID gets PosMai {
...
func (m PositionMaintenanceRequest) GetFXCMSymID() (v string, err quickfix.MessageRejectError) {
...
func (m PositionMaintenanceRequest) GetFXCMSymPrecision() (v int, err quickfix.MessageRejectError) {
	var f field.FXCMSymPrecisionField
	if err = m.Get(&f); err == nil {
		v = return m.Has(tag.RedemptionDate)
}
...
// HasSecurityAltIDSource returns true if SecurityAltIDSo
...
// HasLegStateOrProvinceOfIssue returns true if LegStateOrProvinceOfIssue is present, Tag 597.
func (m NoHasNoNestedPartyIDs() bool {
...
// HasNestedPartyID returns true if NestedPartyID is present, T
...
func (m NoUnderlyings) SetUnderlyingRedemptionDate(v string) {
	m.Set(field.NewUnderlyingR== nil {
		v = f.Value()
	}
	return
}
...
func (m NoUnderlyings) GetUnderlyingCouponRate() (v decimal.Decimal, e
...
func (m NoUnderlyings) SetEncodedUnder
		v = f.Value()
	}
	return
}
...
// HasUnderlyingCurrentValue returns true if UnderlyingCurrentValue is present,quickfix.MessageRejectError) {
	var f field.UnderlyingCPRegTypeField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
