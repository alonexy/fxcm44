...
func (m AllocationReport) SetBenchmarkSecurityIDSource(v enum.BenchmarkSecurityIDSource) {
...
func (m AllocationReport) GetBenchmarkSecurityIDSource() (v enum.BenchmarkSecurityIDSource, err quickfix.MessageRejectError) {
...
func (m NoUnderlyings) GetUnderlyingSfunc (m NoUnderlyings) SetUnderlyingSymbol(v string) {
	m.Set(field.NewUnderlyingSymbol(v))
}
...
// GetUnderlyingContractMultiplier gets UnderlyingContractMultiplier, Tag 43 bool {
