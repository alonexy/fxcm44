...
func (m Email) SetTradingSessionID(v enum.TradingSessionID) {
...
func (m Email) SetTradingSessionSubID(v enum.TradingSessionSubID) {
...
// Geint, err quickfix.MessageRejectError) {
