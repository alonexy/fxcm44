...
func (m NewOrderMultileg) SetRoundLot(value decimal.Decimal, scale int32) {
...
// SetQt (m NewOrderMultileg) SetNoEvents(f NoEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
// GetRoundingDirection gets RoundingDirection, Tag 468.
func (m NewOrderMultileg) GetRoundingDirection nil {
		v = f.Value()
	}
	return
}
...
func (m NewOrderMultileg) GetFXCMMaxQuantity() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NewOrderMultileg) GetFXCMMinQuantity() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NewOrderMultileg) GetFXCMTradingStatus() (v string, err quickfix.MessageRejectError) {
...
func (m NewOrde HasDiscretionOffsetType() bool {
