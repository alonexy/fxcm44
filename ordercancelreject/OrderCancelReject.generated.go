...
func (m OrderCancelReject) SetTradingSessionID(v enum.TradingSessionID) {
...
func (m OrderCancelReject) SetTradingSessionSubID(v enum.TradingSessionSubID) {
...
func (m OrderCancelReject) SetFXCMRequestRejectReason(v enum.FXCMRequestRejectReason) {
	m.Set(field.NewFXCMRequestRejectReason(v))
}

// SetFXCMErrorDetails sets FXCMErrorDetails, Tag 9029.
func (m OrderCancelReject) SetFXCMErrorDetails(v string) {
...
func (m OrderCancelReject) GetTradingSessionID() (v enum.TradingSessionID, err quickfix.MessageRejectError) {
...
func (m OrderCancelReject) GetTradingSessionSubID() (v enum.TradingSessionSubID, err quickfix.MessageRejectError) {
...
func (m OrderCancelReject) GetFXCMRequestRejectReason() (v enum.FXCMRequestRejectReason, err quickfix.MessageRejectError) {
...
func (m OrderCancelReject) GetFXCMErrorDetails() (v string, err quickfix.MessageRejectError) {
...
func (m OrderCancelReject) HasTradingSessionID() bool {
...
func (m OrderCancelReject) HasTradingSessionSubID() bool {
