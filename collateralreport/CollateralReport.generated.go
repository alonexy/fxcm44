...
func (m CollateralReport) SetBenchmarkSecurityIDSource(v enum.BenchmarkSecurityIDSource) {
...
func (m CollateralReport) GetBenchmarkSecurityIDSource() (v enum.BenchmarkSecurityIDSource, err quickfix.MessageRejectError) {
