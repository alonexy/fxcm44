...
func (m TradeCaptureReport) SetBenchmarkSecurityIDSource(v enum.BenchmarkSecurityIDSource) {
...
func (m TradeCaptureReport) GetBenchmarkSecurityIDSource() (v enum.BenchmarkSecurityIDSource, err quickfix.MessageRejectError) {
...
func (m NoUnderlyings) GetUnderlyingIssuer() (v string, err quickfix.MessageRejectError) {
	...
	if err = m.Get(&f); err == nil {
		 NoUnderlyings) HasEncodedUnderlyingSecurityDescLen() bool {
...
func (m NoUnderlyings) HasUnderlyingCurrency() bo= f.Value()
	}
	return
}
...
func (m NoUnderlyingStips) HasUnderlyingStipType() m.Has(tag.EventPx)
}
...
ingStips in the NoUnderlyingStipsRepeatinGroup.
