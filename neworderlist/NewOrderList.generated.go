...
func New(listid field.ListIDField, totnoorders field.TotNoOrdersField) (m NewOrderList) {
...
func (m NewOrderList) SetFXCMContingencyID(v string) {
...
func (m NewOrderList) GetFXCMContingencyID() (v string, err quickfix.MessageRejectError) {
...
func (m NewOrderList) HasFXCMContingencyID() bool {
...
func (m NoOrders) SetBenchmarkSecurityIDSource(v enum.BenchmarkSecurityIDSource) {
...
func (m NoOrders) SetFXCMPegFluctuatePts(v int) {
...
func (m NoOrders) SetFXCMPosID(v string) {
...
func (m NoOrders) GetFXCMSymID() (v string, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetFXCMSymPrecision() (v int, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetFXCMSymPointSize() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetFXCMSymSortOrder() (v int, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetFXCMProductID() (v int, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetFXCMSymMarginRatio() (v decimal.Decimal, err quickfix.MessageRejectError) {
	var f field.
	return
}
...
// HasSecurityIDSource returns true if Securit= m.Get(&f); err == nil {
		v = f.Value()
	}
	return
}
...
func (m NoOrders) GetFXCMPegFluctuatePts() (v int, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetFXCMPosID() (v string, err quickfix.MessageRejectError) {
...
// HasSettlType returns true if SNoOrders) HasPrice() bool {
...
// SetUnderlyingRepoCollateralSecurityType sets UnderlyingRepoColla	m.Set(field.NewNestedPartySubID(v))
}
...
// HasUnderlyingIssuer returns true if UnderlyingIssuer
	}
	return
}
...
// GetUnderlyingDirtyPrice gets UnderlyingDirtyPrice, Tag 882.
func (m NoUnderlyings) GetUnderlyingDirtyPrice() (v dec f.Value()
	}
	return
}
