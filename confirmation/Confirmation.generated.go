...
func (m Confirmation) SetBenchmarkSecurityIDSource(v enum.BenchmarkSecurityIDSource) {
...
func (m Confirmation) GetBenchmarkSecurityIDSource() (v enum.BenchmarkSecurityIDSource, err quickfix.MessageRejectError) {
