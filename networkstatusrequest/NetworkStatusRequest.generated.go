...
// NetworkStatusRequest is the fix44 NetworkStatusRequest type, MsgType = BC.
...
// FromMessage creates a NetworkStatusRequest from a quickfix.Message instance.
func FromMessage(m *quickfix.Message) NetworkStatusRequest {
...
func (m NetworkStatusRequest) ToMessage() *quickfix.Message {
	return m.Message
}

// New returns a NetworkStatusRequest initialized with the required fields for NetworkStatusRequest.
func New(networkrequesttype field.NetworkRequestTypeField, networkrequestid field.NetworkRequestIDField) (m NetworkStatusRequest) {
...
type RouteOut func(msg NetworkStatusRequest, sessionID quickfix.SessionID) quickfix.MessageRejectError
...
func (m NetworkStatusRequest) SetNetworkRequestID(v string) {
	m.Set(field.NewNetworkRequestID(v))
}

// SetNetworkRequestType sets NetworkRequestType, Tag 935.
func (m NetworkStatusRequest) SetNetworkRequestType(v enum.NetworkRequestType) {
	m.Set(field.NewNetworkRequestType(v))
}

// SetNoCompIDs sets NoCompIDs, Tag 936.
func (m NetworkStatusRequest) SetNoCompIDs(f NoCompIDsRepeatingGroup) {
	m.SetGroup(f)
}

// GetNetworkRequestID gets NetworkRequestID, Tag 933.
func (m NetworkStatusRequest) GetNetworkRequestID() (v string, err quickfix.MessageRejectError) {
...
func (m NetworkStatusRequest) GetNetworkRequestType() (v enum.NetworkRequestType, err quickfix.MessageRejectError) {
...
func (m NetworkStatusRequest) GetNoCompIDs() (NoCompIDsRepeatingGroup, quickfix.MessageRejectError) {
