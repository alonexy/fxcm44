...
func (m OrderMassStatusRequest) SetRoundLot(value decimal.Decimal, scale int32) {
...
// GetEncodedSecurityDescLen gets Encoded}
	return
}
...
// SetUnderlyingStipType sets Unde (m NoPartyIDs) HasPartyID() bool {
	return m.Has(tag.PartyID)
}
