...
func (m AllocationInstruction) SetBenchmarkSecurityIDSource(v enum.BenchmarkSecurityIDSource) {
...
func (m AllocationInstruction) GetBenchmarkSecurityIDSource() (v enum.BenchmarkSecurityIDSource, err quickfix.MessageRejectError) {
...
// NewNoClearingInstructionsRepeatingGroup returns an initialized, NoClearingInstructionsRepeati(m NoAllocs) HasSettlCurrFxRate() bool {
	return m.Has(tag.SettlCurrFxRate)
}
...
// HasClearingInstruction returns true if ClearingInstruction is present, Tag 577.
func (m NoAllocs) HasClearingInstruction() bool {
	return m.Has(tag.ClearingInstruction)
}
...
func NewNoExecsRepeatingGroup() NoExecsRepeatingGroup {
	return NoExecsRepeatingGroup{
		quickfix.NewRepeatingGroup(tag.NoExecs,
			quickfix.GroupTemplate{quickfix.GroupE = f.Value()
	}
	return
}
...
func NewNoSettlPartyIDsRepeatingGroup() NoSettlPartyIDsRepeatingGroup {
	return NoSettlPartyIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(tag.NoSettlPartyIDs,
			quickfix.GroupTemplate{quickfix.GroupElement(tag.SettlPartyID), quickfix.GroupElement(tag.SettlPartyIDSource), quickfix.GroupElement(tag.SettlPartyRole), NewNoSettlPar
}
