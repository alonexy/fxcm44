...
func (m SecurityStatusRequest) SetRoundLot(value decimal.Decimal, scale int32) {
...
// GetStrikePrice gets Stri err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
}
