...
func (m NewOrderSingle) SetBenchmarkSecurityIDSource(v enum.BenchmarkSecurityIDSource) {
...
func (m NewOrderSingle) GetBenchmarkSecurityIDSource() (v enum.BenchmarkSecurityIDSource, err quickfix.MessageRejectError) {
...
f UnderlyingDirtyPrice is present, Tag 882.
func (m NoUnderlyings) HasUnderlyingDirtyPrice() bool {
	return m.Has(tag.UnderlyingDirtyPrice)
}
