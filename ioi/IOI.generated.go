...
func (m IOI) SetBenchmarkSecurityIDSource(v enum.BenchmarkSecurityIDSource) {
...
func (m IOI) GetBenchmarkSecurityIDSource() (v enum.BenchmarkSecurityIDSource, err quickfix.MessageRejectError) {
