...
func (m QuoteResponse) SetSecondaryClOrdID(v string) {
...
func (m QuoteResponse) SetRoundLot(value decimal.Decimal, scale int32) {
...
func (m QuoteResponse) SetMidYield(value decimal.DecimSetBidForwardPoints2(value decimal.Decimal, scale int32) {
...
func (m QuoteResponse) SetBenchmarkSecurityIDSource(v enum.BenchmarkSecurityIDSource) {
...
func (m QuoteResponse) GetYi err == nil {
		v = f.Value()
	}
	return
}
...
func (m QuoteResponse) GetBenchmarkSecurityIDSource() (v enum.BenchmarkSecurityIDSource, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetFXCMSymID() (v string, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetFXCMSymPrecision() (v int, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetFXCMSymPointSize() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetFXCMSymInterestBuy() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetFXCMSymInterestSell() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetFXCMSymSortOrder() (v int, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetFXCMSymMarginRatio() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetFXCMSubscriptionStatus() (v string, err quickfix.MessageRejectError) {
...
// GetFXCMProductID gets FX(m QuoteResponse) HasSecurityExchange() bool {
...
// HasProduct returns true if Product is p m.Has(tag.SettlDate)
}
...
func (m QuoteResponse) HasSecondaryClOrdID() bool {
...
func (m QuoteResponse) HasRoundLot() bool {
...
func (m QuoteResponse) HasSettlCurrOfferFxRate
//bool {
	return m.Has(tag.SettlCurrOfferFxRate)
}

// HasAcctIDSource returns true if Acctenum.PartyIDSource, err quickfix.Me(m QuoteResponse) Hasvar f field.PartyIDSo
	return m.Haserr = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
}
...
func (m NoLegs) SetLegRepurchaseRate(value decimal.Decimal, scale int32) {
	m.Set(field.NewLegRepurchaseRate(vm.Get scaleer
}
...
// HasStipulationType returns true if StipulationType is present, Tag 23m.
func (m NoStipulations) HasStipulationTy// Sebool {
	return m.Has(tag.StipulationType)
}

// HasStipulationValue returns true if Stipulati{
	m.Set(field.NewLegCreditRating (m No

// SetLegInstrRegistry sets LegIn bool {
	return m.Has(tag.StipulationVSetLe
}
...
// SetLegCountryOfIssue sets LegCountryO {
	*quickfix.Repeatin(m NoLe}

// NewNoStipulationsRepestring) {
...
// SetLegOptAttribute sets LeSetPartyID(v string) {
	m.Set(field.New SetLegOptAt}

// SetPartyIDSo{
	m.Set(field.NewLegOptAttribute(v))
}

// SetLegContSetPartyIDSource(v enum.PartyIDSource) {
	m.Set(field.NewPartyIDSou SetLegC}

// SetPartyRole sets PartyRole, Tag 452.
func (m NoParm.Set( SetPartyRole(v enum.PartyRole) {
	m.Set(field.Ne// SetLegCoupo
}

// SetNoPartySubIDs sets NoPartySubI(m NoLegs) SetLegC(m NoPartyIDs) SetNoPartySubIDs(f NoPartySubI {
	m.Set(field.NewLem.SetGroup(f)
}

// GetParty

// SetLegSecurityExchange se (m NoPartyIDs) GetPartyID() (v string, err quickfix.MessageRejectError) {
...
// Get returns the ith NoPartyIDs in the NoPartyIDsRepeatinGroup.
fu fi(m NoPartyIDsRepeatiif err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
}
...
func (m NoLegs) GetLegSecuritySubType() (v string, err quickfix.GroupElement(tag.SecurityAltIDSource)})}
}
...
// HasLegSecurityExchange returns true if LegSecurityExchange i bool {
