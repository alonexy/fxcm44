...
func (m OrderCancelReplaceRequest) SetLeavesQty(value decimal.Decimal, scale int32) {
...
// SetBenchmarkC// SetBenchmarkCurvePoint sets BenchmarkCurvePoint, Tag 222.
...
func (m OrderCancelReplaceRequest) SetBenchmarkSecurityIDSource(v enum.BenchmarkSecurityIDSource) {
...
func (m OrderCancelReplaceRequest) GetMinQty() (v decimal.Decimal,  f.Value()
	}
	return
}
...
func (m OrderCancelReplaceRequest) GetLeavesQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetRoundLot() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetBenchmarkSecurityIDSource() (v enum.BenchmarkSecurityIDSource, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetContingencyType() (v enum.ContingencyType, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMSymID() (v string, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMSymPrecision() (v int, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMSymPointSize() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMSymInterestBuy() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMSymInterestSell() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMSymSortOrder() (v int, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMSymMarginRatio() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMPegFluctuatePts() (v int, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMSubscriptionStatus() (v string, err quickfix.MessageRejectError) {
...
// GetFXCMContingencyID gets FXCMContingencyID, Tag 9079.
func (m OrderCancelReplaceRequest) GetFXCMContingencyID() (v string, err quickfix.MessageRejectError) {
	var f field.FXCMContingencyIDField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m OrderCancelReplaceRequest) GetFXCMProductID() (v int, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMCondDistStop() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMCondDistLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMCondDistEntryStop() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMCondDistEntryLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMMaxQuantity() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMMinQuantity() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFXCMTradingStatus() (v string, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) HasLeavesQty() bool {
...
func (m OrderCancelReplaceRequest) HasRoundLot() bool {
