...
func (m NoRelatedSym) SetBenchmarkSecurityIDSource(v enum.BenchmarkSecurityIDSource) {
...
func (m NoRelatedSym) GetBenchmarkSecurityIDSource() (v enum.BenchmarkSecurityIDSource, err quickfix.MessageRejectError) {
