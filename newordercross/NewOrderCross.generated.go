...
func (m NewOrderCross) SetRoundLot(value decimal.Decimal, scale int32) {
...
func (m NewOrderCross) SetBenchmarkSecurityIDSource(v enum.BenchmarkSecurityIDSource) {
...
func (m NewOrderCross) GetRoundLot() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetBenchmarkSecurityIDSource() (v enum.BenchmarkSecurityIDSource, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetPegRoundDirection() (v enum.PegRou (v string, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMSymID() (v string, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMSymPrecision() (v int, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMSymPointSize() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMSymInterestBuy() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMSymInterestSell() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMSymSortOrder() (v int, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMSymMarginRatio() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMPegFluctuatePts() (v int, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMSubscriptionStatus() (v string, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMProductID() (v int, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMCondDistStop() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMCondDistLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMCondDistEntryStop() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMCondDistEntryLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMMaxQuantity() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMMinQuantity() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetFXCMTradingStatus() (v string, err quickfix.MessageRejectError) {
...
// GetSecondaryClOrdID gets SecondaryClOrdID, 
}
...
ue if UnderlyingCurrentValue is present, Tag 885.
